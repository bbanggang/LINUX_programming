...
public: // public 영역
    ...
    void setVideoIn(bool videoIn); // 비디오 입력 여부 설정
...
public: // public 영역
    SmartTV(); // 기본 생성자
    SmartTV(int size, string ipAddr); // 값 생성자
    void setSmartTV(int size, bool videoIn, string ipAddr); // SmartTV 값 설정
